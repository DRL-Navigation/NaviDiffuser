...
if __name__ == "__main__":
    ...
    dataloader = DL(dataset=dataset, batch_size=cfg['Dataset']['batch'], num_workers=world_size, shuffle=True, collate_fn=collate.collate_fn, drop_last=True, pin_memory=True)
