...
def create_net(configs) -> Basenn:
    ...
    if config.USE_RND:
        ...
        rnd_net = RND(pre_f=NavPreNet1D(image_channel=3, last_output_dim=config_nn.AC_INPUT_DIM),
                      pre_p=NavPreNet1D(image_channel=3, last_output_dim=config_nn.AC_INPUT_DIM),
