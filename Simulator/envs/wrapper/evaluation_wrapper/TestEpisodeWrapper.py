...
class TestEpisodeWrapper(gym.Wrapper):
    ...
    def __init__(self, env, cfg):
        ...
        self.w_sum = 0
        self.speed_step = 0
        self.target_reward_sum = 0
        self.obs_reward_sum = 0
        self.jerk_reward_sum = 0
    ...
    def step(self, action, **kwargs):
        ...
        self.target_reward_sum += reward[0][0]
        self.obs_reward_sum += reward[0][1]
        self.jerk_reward_sum += reward[0][2]
    ...
    def screen_out(self):
        print("""\n
                    ...
                    """.format(self.max_episodes,
                               ...
                               self.target_reward_sum / self.speed_step,
                               self.obs_reward_sum / self.speed_step,
                               self.jerk_reward_sum / self.speed_step
                               ), flush=True)
